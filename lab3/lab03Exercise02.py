...
Lab: lab03-exercise02
Last modified: Friday, September 29, 2023
Purpose: a user fills out two lists of integer, and a program will print statistics based on the lists.
'''
...
average2=0
commonValues=0
#Here I am simply declaring variables that will be used later on in the statistics of the program.
...
for num in intList2:
    sum2+= num
#Sum Calculator/Common Value Counter
